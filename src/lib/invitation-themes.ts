...
export const storybookThemes = {
  midnight: {
    "--sb-bg": "#0b0d18",
    "--sb-page-dark": "#171b2e",
    "--sb-page-dark-2": "#1e2240",
    "--sb-page-light": "#faf5ec",
    "--sb-page-light-2": "#f0eadd",
    "--sb-page-light-3": "#e8e0cf",
    "--sb-gold": "#c9a96e",
    "--sb-gold-light": "#dfc49c",
    "--sb-gold-dark": "#a08347",
    "--sb-gold-muted": "rgba(201, 169, 110, 0.35)",
    "--sb-text-on-dark": "#ede7db",
    "--sb-text-on-dark-muted": "rgba(237, 231, 219, 0.55)",
    "--sb-text-on-light": "#2a2d3e",
    "--sb-text-on-light-muted": "rgba(42, 45, 62, 0.5)",
    "--sb-rose": "#c4868c",
    "--sb-rose-muted": "rgba(196, 134, 140, 0.3)",
    "--sb-sage": "#8fa88a",
    "--sb-spine-color": "#12142a",
    "--sb-spine-highlight": "rgba(201, 169, 110, 0.12)",
    "--sb-perspective": "2200px",
    "--sb-flip-duration": "1.1s",
    "--sb-flip-easing": "cubic-bezier(0.645, 0.045, 0.355, 1)",
    "--sb-content-easing": "cubic-bezier(0.4, 0, 0.2, 1)",
  },
  ivory: {
    "--sb-bg": "#1a1814",
    "--sb-page-dark": "#2c2518",
    "--sb-page-dark-2": "#3a3020",
    "--sb-page-light": "#faf8f2",
    "--sb-page-light-2": "#f5f0e6",
    "--sb-page-light-3": "#ede5d5",
    "--sb-gold": "#c9a227",
    "--sb-gold-light": "#d4af37",
    "--sb-gold-dark": "#8b7355",
    "--sb-gold-muted": "rgba(201, 162, 39, 0.35)",
    "--sb-text-on-dark": "#f0e8d8",
    "--sb-text-on-dark-muted": "rgba(240, 232, 216, 0.55)",
    "--sb-text-on-light": "#2c1810",
    "--sb-text-on-light-muted": "rgba(44, 24, 16, 0.5)",
    "--sb-rose": "#c4868c",
    "--sb-rose-muted": "rgba(196, 134, 140, 0.25)",
    "--sb-sage": "#8fa88a",
    "--sb-spine-color": "#1a1610",
    "--sb-spine-highlight": "rgba(201, 162, 39, 0.15)",
    "--sb-perspective": "2200px",
    "--sb-flip-duration": "1.1s",
    "--sb-flip-easing": "cubic-bezier(0.645, 0.045, 0.355, 1)",
    "--sb-content-easing": "cubic-bezier(0.4, 0, 0.2, 1)",
  ...
  blush: {
    "--sb-bg": "#2d2226",
    "--sb-page-dark": "#3a2830",
    "--sb-page-dark-2": "#4a3540",
    "--sb-page-light": "#fdf8f8",
    "--sb-page-light-2": "#faf0f0",
    "--sb-page-light-3": "#f5e8e8",
    "--sb-gold": "#b76e79",
    "--sb-gold-light": "#d4a5a5",
    "--sb-gold-dark": "#8b5a5a",
    "--sb-gold-muted": "rgba(183, 110, 121, 0.35)",
    "--sb-text-on-dark": "#f5e8ea",
    "--sb-text-on-dark-muted": "rgba(245, 232, 234, 0.55)",
    "--sb-text-on-light": "#3d2428",
    "--sb-text-on-light-muted": "rgba(61, 36, 40, 0.5)",
    "--sb-rose": "#d4a5a5",
    "--sb-rose-muted": "rgba(212, 165, 165, 0.3)",
    "--sb-sage": "#a8b8a0",
    "--sb-spine-color": "#2a1e22",
    "--sb-spine-highlight": "rgba(183, 110, 121, 0.15)",
    "--sb-perspective": "2200px",
    "--sb-flip-duration": "1.1s",
    "--sb-flip-easing": "cubic-bezier(0.645, 0.045, 0.355, 1)",
    "--sb-content-easing": "cubic-bezier(0.4, 0, 0.2, 1)",
  ...
  sage: {
    "--sb-bg": "#1e2420",
    "--sb-page-dark": "#253028",
    "--sb-page-dark-2": "#2e3a32",
    "--sb-page-light": "#f8faf6",
    "--sb-page-light-2": "#f0f5eb",
    "--sb-page-light-3": "#e5eed8",
    "--sb-gold": "#7d9471",
    "--sb-gold-light": "#9ab08f",
    "--sb-gold-dark": "#5a6b52",
    "--sb-gold-muted": "rgba(125, 148, 113, 0.35)",
    "--sb-text-on-dark": "#e8f0e0",
    "--sb-text-on-dark-muted": "rgba(232, 240, 224, 0.55)",
    "--sb-text-on-light": "#2c332a",
    "--sb-text-on-light-muted": "rgba(44, 51, 42, 0.5)",
    "--sb-rose": "#b89090",
    "--sb-rose-muted": "rgba(184, 144, 144, 0.25)",
    "--sb-sage": "#8fa88a",
    "--sb-spine-color": "#1a2018",
    "--sb-spine-highlight": "rgba(125, 148, 113, 0.15)",
    "--sb-perspective": "2200px",
    "--sb-flip-duration": "1.1s",
    "--sb-flip-easing": "cubic-bezier(0.645, 0.045, 0.355, 1)",
    "--sb-content-easing": "cubic-bezier(0.4, 0, 0.2, 1)",
  ...
  champagne: {
    "--sb-bg": "#1f1a14",
    "--sb-page-dark": "#2a2218",
    "--sb-page-dark-2": "#352c20",
    "--sb-page-light": "#faf6ed",
    "--sb-page-light-2": "#f5f0e3",
    "--sb-page-light-3": "#ebe5d5",
    "--sb-gold": "#c9a961",
    "--sb-gold-light": "#e0c080",
    "--sb-gold-dark": "#9a8030",
    "--sb-gold-muted": "rgba(201, 169, 97, 0.35)",
    "--sb-text-on-dark": "#f0e8d5",
    "--sb-text-on-dark-muted": "rgba(240, 232, 213, 0.55)",
    "--sb-text-on-light": "#3d3520",
    "--sb-text-on-light-muted": "rgba(61, 53, 32, 0.5)",
    "--sb-rose": "#c4908c",
    "--sb-rose-muted": "rgba(196, 144, 140, 0.25)",
    "--sb-sage": "#8fa88a",
    "--sb-spine-color": "#1a1610",
    "--sb-spine-highlight": "rgba(201, 169, 97, 0.15)",
    "--sb-perspective": "2200px",
    "--sb-flip-duration": "1.1s",
    "--sb-flip-easing": "cubic-bezier(0.645, 0.045, 0.355, 1)",
    "--sb-content-easing": "cubic-bezier(0.4, 0, 0.2, 1)",
