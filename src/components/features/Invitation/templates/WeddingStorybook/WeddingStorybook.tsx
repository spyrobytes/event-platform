...
function mapToStorybook(data: InvitationData): StorybookData {
  ...
  return {
    ...
    date: formattedDate,
    year,
    ceremonyTime: data.eventTime,
    ceremonyVenue: data.venue.name,
    ceremonyAddress: [data.venue.address, data.venue.city].filter(Boolean).join(", "),
    receptionTime: data.receptionTime || data.eventTime,
    receptionVenue: data.receptionVenue || data.venue.name,
    receptionAddress: data.receptionAddress || [data.venue.address, data.venue.city].filter(Boolean).join(", "),
