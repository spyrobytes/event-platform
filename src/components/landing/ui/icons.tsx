...
/*
 * Heroicons-outline glyphs shared by the landing sections — a path that
 * appears in a second section moves here instead of being inlined again.
 * Size via className; stroke follows currentColor.
 */
