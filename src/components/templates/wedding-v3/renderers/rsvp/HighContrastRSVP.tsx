  ...
  return (
    <section
      style={{
        ...
        color: "var(--lux-ink, rgba(255,255,255,0.9))",
      }}
      aria-label="RSVP"
      id="rsvp"
    >
      ...
      >
        ...
        <h2 style={{ fontFamily: "var(--serif)", fontSize: "var(--h2)", fontWeight: 400, color: "var(--lux-ink, #ffffff)", marginBottom: "clamp(8px, 1vw, 12px)" }}>
          {heading}
        </h2>
        {data.description && (
          <p style={{ fontFamily: "var(--sans)", fontSize: "var(--body)", color: "var(--lux-ink-soft, rgba(255,255,255,0.6))", lineHeight: 1.75, maxWidth: "48ch", margin: "0 auto clamp(32px, 4vw, 48px)" }}>
            {data.description}
          </p>
        )}
        ...
        <div
          style={{
            maxWidth: 520,
            margin: "0 auto",
            background: "var(--lux-card, rgba(255,255,255,0.05))",
            border: "1px solid var(--lux-line, rgba(255,255,255,0.1))",
            borderRadius: 4,
        ...
        >
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "linear-gradient(90deg, var(--lux-accent, var(--accent, #c5a55a)), transparent)" }} />
