...
export function SpeakersSection({ data, assets, primaryColor }: SpeakersSectionProps) {
  ...
  return (
    <SectionWrapper ariaLabel="Speakers and guests" className="bg-muted/20">
      ...
      <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((speaker, index) => {
          ...
          return (
            <div
              key={index}
              className="group relative overflow-hidden rounded-3xl border-4 bg-card p-6 text-center transition-transform hover:scale-[1.02]"
            ...
            >
              ...
              {/* Photo */}
              <div
                className="relative mx-auto mb-4 h-36 w-36 overflow-hidden rounded-full border-4"
