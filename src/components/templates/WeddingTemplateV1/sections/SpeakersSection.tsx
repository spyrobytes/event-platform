...
/**
 * Speakers/Guests Section for Wedding template
 * Elegant card layout with soft styling
 */
export function SpeakersSection({ data, assets, primaryColor }: SpeakersSectionProps) {
  const { heading = "Special Guests", description, items } = data;
  ...
  return (
    <SectionWrapper ariaLabel="Speakers and guests">
            ...
            >
              ...
              <div className="mx-auto mb-4 h-32 w-32 overflow-hidden rounded-full border-4" style={{ borderColor: `${primaryColor}30` }}>
                {speakerImage?.publicUrl ? (
                  ...
                  <div
                    className="flex h-full w-full items-center justify-center text-3xl font-light text-white"
