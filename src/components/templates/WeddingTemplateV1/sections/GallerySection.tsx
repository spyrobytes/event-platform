      ...
      {galleryItems.length > 3 && (
        <>
          <button
            ...
            className="absolute -left-4 top-1/2 z-10 -translate-y-1/2 rounded-full bg-white/90 p-2 shadow-lg transition-all hover:bg-white hover:scale-110"
          ...
          <button
            ...
            className="absolute -right-4 top-1/2 z-10 -translate-y-1/2 rounded-full bg-white/90 p-2 shadow-lg transition-all hover:bg-white hover:scale-110"
      ...
      >
        {galleryItems.map((item, index) => (
          <button
            ...
            type="button"
            onClick={() => openLightbox(index)}
            className="group relative aspect-[4/3] w-72 flex-shrink-0 overflow-hidden rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2"
            style={{ "--tw-ring-color": primaryColor } as React.CSSProperties}
          >
            <EventImage
              src={item.asset.publicUrl || ""}
    ...
    <div className="columns-2 gap-4 lg:columns-3">
      {galleryItems.map((item, index) => (
        <button
          ...
          type="button"
          onClick={() => openLightbox(index)}
          className="group relative mb-4 block aspect-[3/4] w-full overflow-hidden rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2"
          style={{ "--tw-ring-color": primaryColor } as React.CSSProperties}
        >
          <EventImage
            src={item.asset.publicUrl || ""}
  ...
  const renderSlideshow = () => (
    ...
    >
      ...
      <div className="relative aspect-[16/9] overflow-hidden rounded-xl bg-muted">
        ...
        {autoPlay && isPaused && (
          <div className="absolute left-4 top-4 rounded-full bg-white/20 px-3 py-1 text-xs text-white backdrop-blur-sm">
            Paused
          </div>
        )}
      </div>
    ...
    <SectionWrapper ariaLabel="Photo gallery" className="bg-muted/30">
      ...
      {lightboxIndex !== null && currentItem && (
        ...
        >
          ...
          {/* Auto-play indicator */}
          {autoPlay && (
            <div className="absolute left-4 top-4 z-10 flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-sm text-white">
              {isPaused ? (
                <>
          ...
          {/* Image and caption with transition */}
