...
// that declare `weddingPartyStyleOptions` (currently Grand Luxe: Cinematic,
// Gilded Frames, Couture Polaroid); other templates ignore it and use their
// fixed renderer. Optional for backward compatibility — unset resolves to the
// template's default style. "scrapbook" is retained for legacy persisted values.
